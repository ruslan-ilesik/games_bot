...
public:
   ...
   * the module.
   */
  Discord_bot(const std::string &name,
   ...
   */
  virtual void reply(const dpp::slashcommand_t &event,
   ...
   * custom callback function to handle the completion event as needed.
   */
  virtual void reply(const dpp::select_click_t &event,
                     const dpp::message &message,
                     const dpp::command_completion_event_t &callback =
                         dpp::utility::log_error()) = 0;
   ...
   * custom callback function to handle the completion event as needed.
   */
  virtual void reply(const dpp::button_click_t &event,
                     const dpp::message &message,
                     const dpp::command_completion_event_t &callback =
                         dpp::utility::log_error()) = 0;
   ...
   * custom callback function to handle the completion event as needed.
   */
  virtual void reply_new(const dpp::button_click_t &event,
                         const dpp::message &message,
                         const dpp::command_completion_event_t &callback =
                             dpp::utility::log_error()) = 0;
