...
namespace gb {
    dpp::task<void> Discord_puzzle_15_command_impl::_command_callback(const dpp::slashcommand_t &event) {
    ...
    void Discord_puzzle_15_command_impl::run() { Discord_puzzle_15_command::run(); }
