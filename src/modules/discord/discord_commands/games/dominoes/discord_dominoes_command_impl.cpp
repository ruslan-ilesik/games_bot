...
namespace gb {
    Discord_dominoes_command_impl::Discord_dominoes_command_impl() :
        ...
        lobby_description = "Dominoes is a family of tile-based games played with gaming pieces, commonly known as dominoes.";
            ...
            _command_handler->register_command(_discord->create_discord_command(
                ...
                [this](const dpp::slashcommand_t &event) -> dpp::task<void> {
                    ...
                    if (players_amount < 2 || players_amount > 4) {
                        ...
                        .set_title("Error!")
                        .set_description("players amount should be between 2 and 4, while you gave "+ std::to_string(players_amount));
