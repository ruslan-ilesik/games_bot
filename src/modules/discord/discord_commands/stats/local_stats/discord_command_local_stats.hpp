...
namespace gb {
  ...
  // Abstract class declaration for Discord_command_local_stats
  class Discord_command_local_stats: public Discord_general_command {
  public:
    // Constructor that initializes the command with a name and a list of dependencies
    Discord_command_local_stats(const std::string& name, const std::vector<std::string>& dependencies)
