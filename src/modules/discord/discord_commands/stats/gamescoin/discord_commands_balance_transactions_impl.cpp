    ...
    void Discord_commands_balance_transactions_impl::init(const Modules &modules) {
        ...
        _bot->add_pre_requirement([this]() {
            ...
            _command_handler->register_command(_discord->create_discord_command(
                ...
                {"Command to get your balance of Gamestokens globally earned avaible for spending", {"statistics"}}));
        });
        ...
        _bot->add_pre_requirement([this]() {
            ...
            _command_handler->register_command(_discord->create_discord_command(
                command, _command_executor,
                {"Command to get your last transactions of Gamestokens (buying, spending, ect) with optional filters", {"statistics"}}));
        });
    }
